...
const Character: React.FC<ICharacter> = ({ name, image, onClick }) => {
    return (
        <div onClick={onClick} data-testid='character' className='w-64 h-64 relative border-2 border-black shadow-1md cursor-pointer overflow-hidden  max-sm:w-full'>
